...
//!
//! Unlike [`crate::hashcache`] (keyed by file *identity*: canonical path plus
...
/// [`crate::hashcache::enabled`] — the two caches have different key
...
/// (e.g. from [`crate::hashcache::sha256_prefixed`] or a
