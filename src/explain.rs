...
pub fn lookup(rule: &str) -> Option<RuleExplanation> {
    ...
    let item = match normalized.as_str() {
        ...
        "LF-ARCHIVE-TRAVERSAL" => RuleExplanation { rule_id: "LF-ARCHIVE-TRAVERSAL", title: "Archive path traversal", meaning: "An archive member path contains illegal absolute prefixes, parent directory traversal, backslashes, drive prefixes, or control characters.", remediation: "Block the archive. Do not extract or process hostile member paths." },
        "LF-ARCHIVE-LINK" => RuleExplanation { rule_id: "LF-ARCHIVE-LINK", title: "Archive symbolic or hard link", meaning: "An archive member is a symbolic or hard link.", remediation: "Review link targets. Layerfault never follows archive links so extraction cannot escape intended boundaries." },
        "LF-ARCHIVE-DUPLICATE" => RuleExplanation { rule_id: "LF-ARCHIVE-DUPLICATE", title: "Archive duplicate or case-colliding member", meaning: "An archive contains multiple entries resolving to the same normalized virtual path or case-insensitive collision.", remediation: "Block or inspect the archive; loader behaviour across case-insensitive filesystems is ambiguous and unsafe." },
        "LF-ARCHIVE-LIMIT" => RuleExplanation { rule_id: "LF-ARCHIVE-LIMIT", title: "Archive resource limit exceeded", meaning: "An archive member or container exceeded bounded member count, uncompressed byte size, path byte limit, or recursion depth.", remediation: "Treat analysis coverage as incomplete and review the oversized container in an isolated workspace." },
        ...
        "LF-ARCHIVE-NESTED" => RuleExplanation { rule_id: "LF-ARCHIVE-NESTED", title: "Nested archive recursion limit", meaning: "A chain of nested archives reached maximum nesting depth or total nested archive count limits.", remediation: "Review the nested container structure and verify inner payloads in an isolated lab." },
        "LF-ARCHIVE-BOMB" => RuleExplanation { rule_id: "LF-ARCHIVE-BOMB", title: "Decompression bomb detected", meaning: "An archive member produced an extreme compression ratio or streaming decompression byte cap violation during unpacking.", remediation: "Block the archive as a denial-of-service attack payload." },
        "LF-ARCHIVE-MALFORMED" => RuleExplanation { rule_id: "LF-ARCHIVE-MALFORMED", title: "Malformed archive container", meaning: "The archive central directory, header structure, or compression stream is corrupted or truncated.", remediation: "Reject the artifact and reacquire it from a verified source." },
        "LF-ARCHIVE-SECURITY-MEMBER" => RuleExplanation { rule_id: "LF-ARCHIVE-SECURITY-MEMBER", title: "Archive security-relevant member", meaning: "An archive member contains metadata or dependency specifications relevant to security inspection.", remediation: "Review member details and dependency claims." },
        "LF-WHEEL-RECORD-MISMATCH" => RuleExplanation { rule_id: "LF-WHEEL-RECORD-MISMATCH", title: "Python Wheel RECORD hash mismatch", meaning: "A Python Wheel entry digest or size differs from the values recorded in .dist-info/RECORD.", remediation: "Block the wheel. Tampering or incomplete packaging was detected." },
        "LF-ARCHIVE-FORMAT-MISMATCH" => RuleExplanation { rule_id: "LF-ARCHIVE-FORMAT-MISMATCH", title: "Archive format smuggling mismatch", meaning: "An archive file extension disagrees with its magic container header signature.", remediation: "Block the artifact and investigate format smuggling." },
