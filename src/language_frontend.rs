...
pub fn scan_language_member(
    ...
    let max_source_bytes = match language {
        LanguageId::Python => {
            crate::python_static::limits::PythonAnalysisLimits::default().max_source_bytes
        }
        LanguageId::Shell => {
            crate::shell_static::limits::ShellAnalysisLimits::default().max_source_bytes
        }
        LanguageId::PowerShell => {
            crate::powershell_static::limits::PowerShellAnalysisLimits::default().max_source_bytes
        }
        LanguageId::JavaScript => {
            crate::javascript_static::limits::JavaScriptAnalysisLimits::default().max_source_bytes
        }
    };
    ...
    let result = match language {
        ...
        LanguageId::Shell => {
            let limits = crate::shell_static::limits::ShellAnalysisLimits::default();
            crate::shell_static::analyze_and_convert_findings(
                rel, source_str, digest, &limits, started,
            )
        }
        LanguageId::PowerShell => {
            let limits = crate::powershell_static::limits::PowerShellAnalysisLimits::default();
            crate::powershell_static::analyze_and_convert_findings(
                rel, source_str, digest, &limits, started,
            )
        }
        LanguageId::JavaScript => {
            let limits = crate::javascript_static::limits::JavaScriptAnalysisLimits::default();
            crate::javascript_static::analyze_and_convert_findings(
