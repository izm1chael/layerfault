...
pub(super) fn check_type_label(check_type: &CheckType) -> &'static str {
    match check_type {
        ...
        CheckType::Intelligence => "Intelligence",
        CheckType::RuntimePosture => "Runtime posture",
        CheckType::RuntimeExploitability => "Runtime exploitability",
        CheckType::RuntimeCompatibility => "Runtime compatibility",
        CheckType::ScannerAssurance => "Scanner assurance",
        CheckType::DeclarativeExecution => "Declarative execution",
        CheckType::TokenizerSecurity => "Tokenizer security",
        CheckType::ModelIdentity => "Model identity",
        CheckType::LineageVerification => "Lineage verification",
        CheckType::TensorForensics => "Tensor forensics",
        CheckType::BackdoorForensics => "Backdoor forensics",
        CheckType::RemotePreflight => "Remote preflight",
        CheckType::SecurityPassport => "Security passport",
        CheckType::ModelComposition => "Model composition",
        CheckType::AgentSecurity => "Agent security",
        CheckType::McpSecurity => "MCP security",
        CheckType::ContinuousTrust => "Continuous trust",
        CheckType::InventoryDrift => "Inventory drift",
