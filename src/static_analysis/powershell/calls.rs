...
//! [`crate::static_analysis::shell::calls::classify_shell_capability`], consuming the
//! shared [`crate::static_analysis::common::capability::ScriptCapability`] directly. Unlike
